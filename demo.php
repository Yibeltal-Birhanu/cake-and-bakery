...
<div id="buyModal" class="modal">
  <div class="modal-content">
   ...
   Full name: <input type="text" name="fname" id="customerName" required>
   Phone:<input type="text" id="customerPhone" required name='pno' />
   Address:<input type="text" id="customerAddress"  required name='address'/>
   City/Zone:<input type="text" id="customerCity" required name='zone'/>
   Birr:<input type='number' id='totalAmount' name='totalAmount'readonly />
   Add Cart:<input type='hidden' id='product_id' name='product_id' value='' />
    <!-- Order Info -->
    <input type="hidden" id="orderItem" name="orderItem" value="" />
    <input type="hidden" id="orderPrice" name="orderPrice" value="" />
    <input type="number" id="orderQuantity" placeholder="Quantity" min="1" value="1" required name='orderQuantity' oninput="updateTotal()" />
